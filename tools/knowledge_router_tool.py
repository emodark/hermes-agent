    ...
    schema={
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "source": {
                    "type": "string",
                    "enum": ["auto", "all", "wiki", "hindsight", "graph", "skill", "symbolic"],
                    "description": "搜索范围: auto(自动路由) / all(全层+图扩散+skill推荐) / wiki / hindsight / graph(联想记忆) / skill(技能推荐) / symbolic(全层+符号系统结构化提取)",
                    "default": "auto",
                },
            },
            "required": ["query"],
