...
LMDB implementation — the main SessionDB class and all LMDB/BM25 internals live here.
hermes_state.py re-exports these symbols for backward compatibility.
...
# ── __all__ ──
# Symbols re-exported by hermes_state.py for backward compatibility.
__all__ = [
    "SessionDB",
    "DEFAULT_DB_PATH",
    "DEFAULT_BM25_PATH",
