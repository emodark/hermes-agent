...
class FailoverReason(enum.Enum):
    ...
    reasoning_content_required = "reasoning_content_required"  # DeepSeek/etc thinking mode requires passing reasoning_content back
...
def _classify_400(
    ...
    *,
    ...
    if "reasoning_content" in error_msg and "must be passed back" in error_msg:
        return result_fn(
            FailoverReason.reasoning_content_required,
            retryable=True,
