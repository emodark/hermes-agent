...
_MULTIMODAL_TOOL_CONTENT_PATTERNS = [
    ...
    # DeepSeek's strict deserialization: tool message content is null/None
    # when a handler returned None. Source fix in make_tool_result_message;
    # this recovery handles stale history already persisted before the fix.
